                       ...
                       <form action="{{ url('/settingProfilku') }}" method="POST" enctype="multipart/form-data">
                        ...
                        {{ csrf_field() }}
                            ...
                            <div class="form-date-w3-agileits">
                                  ...
                                  <input  id="text" name="no_ktp" type="text" value="{{$anak->alamat_sekolah}}" required="">
                            </div>
                            <div class="form-date-w3-agileits">
                                  <label><i class="fa fa-smile-o" aria-hidden="true"></i> Nama Sekolah :</label>
                                  <input  id="no_rek" name="no_rek" type="text" value="{{$anak->nama_sekolah}}" required="">
                            </div>
                            <div class="form-date-w3-agileits">
                                  <label><i class="fa fa-smile-o" aria-hidden="true"></i> Kelas :</label>
                                  <input  id="alamat" name="alamat" type="text" value="{{$anak->kelas}}" required="">
                            </div>
                            <div class="form-date-w3-agileits">
                                  <label><i class="fa fa-smile-o" aria-hidden="true"></i> Jenis Kelamin :</label>
                                  <input  id="pekerjaan" name="pekerjaan" type="text" value="{{$anak->jenis_kelamin}}" required="">
                            </div>
                            <div class="form-date-w3-agileits">
                                  <label><i class="fa fa-smile-o" aria-hidden="true"></i> Tanggal Lahir :</label>
                                  <input  id="email" name="email" type="text" value="{{$anak->tgl_lahir}}" required="">
                            </div>
                            <div class="form-date-w3-agileits">
                                  <label><i class="fa fa-smile-o" aria-hidden="true"></i> Berat Badan :</label>
                                  <input  id="foto" name="foto" type="text" value="{{$anak->bb}}" required="">
                            </div>
                            <div class="form-date-w3-agileits">
                                  <label><i class="fa fa-smile-o" aria-hidden="true"></i> Tinggi Badan :</label>
                                  <input  id="foto" name="foto" type="text" value="{{$anak->tb}}" required="">
                            </div>
                            <div class="form-date-w3-agileits">
                                  <label><i class="fa fa-smile-o" aria-hidden="true"></i> Alergi :</label>
                                  <input  id="foto" name="foto" type="text" value="{{$anak->alergi}}" required="">
                            </div>
